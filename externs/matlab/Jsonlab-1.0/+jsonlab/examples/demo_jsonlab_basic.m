...
data2json=pi
jsonlab.savejson('',data2json)
json2data=jsonlab.loadjson(ans)
...
jsonlab.savejson('specials',data2json)
json2data=jsonlab.loadjson(ans)
...
jsonlab.savejson('sparse',data2json)
json2data=jsonlab.loadjson(ans)
...
jsonlab.savejson('complex_sparse',data2json)
json2data=jsonlab.loadjson(ans)
...
jsonlab.savejson('all_zero_sparse',data2json)
json2data=jsonlab.loadjson(ans)
...
data2json=sparse([]);
jsonlab.savejson('empty_sparse',data2json)
json2data=jsonlab.loadjson(ans)
...
data2json=[];
jsonlab.savejson('empty_0by0_real',data2json)
json2data=jsonlab.loadjson(ans)
...
data2json=zeros(0,3);
jsonlab.savejson('empty_0by3_real',data2json)
json2data=jsonlab.loadjson(ans)
...
jsonlab.savejson('sparse_column_vector',data2json)
json2data=jsonlab.loadjson(ans)
...
jsonlab.savejson('complex_sparse_column_vector',data2json)
json2data=jsonlab.loadjson(ans)
...
data2json=sparse([0,3,0,1,4]);
jsonlab.savejson('sparse_row_vector',data2json)
json2data=jsonlab.loadjson(ans)
...
data2json=data2json-1i*data2json;
jsonlab.savejson('complex_sparse_row_vector',data2json)
json2data=jsonlab.loadjson(ans)
...
jsonlab.savejson('astruct',data2json,struct('ParseLogical',1))
json2data=jsonlab.loadjson(ans)
...
jsonlab.savejson('Supreme Commander',data2json)
json2data=jsonlab.loadjson(ans)
...
jsonlab.savejson('debian',data2json,struct('FloatFormat','%.2f'))
json2data=jsonlab.loadjson(ans)
...
json2data=jsonlab.loadjson('{"ValidName":1, "_InvalidName":2, ":Field:":3, "项目":"绝密"}')
...
jsonlab.savejson('data2json',data2json)
json2data=jsonlab.loadjson(ans)  % only savejson works for cell arrays, loadjson has issues
