...
data2json=pi
jsonlab.saveubjson('',data2json)
json2data=jsonlab.loadubjson(ans)
...
jsonlab.saveubjson('specials',data2json)
json2data=jsonlab.loadubjson(ans)
...
jsonlab.saveubjson('sparse',data2json)
json2data=jsonlab.loadubjson(ans)
...
jsonlab.saveubjson('complex_sparse',data2json)
json2data=jsonlab.loadubjson(ans)
...
jsonlab.saveubjson('all_zero_sparse',data2json)
json2data=jsonlab.loadubjson(ans)
...
data2json=sparse([]);
jsonlab.saveubjson('empty_sparse',data2json)
json2data=jsonlab.loadubjson(ans)
...
data2json=[];
jsonlab.saveubjson('empty_0by0_real',data2json)
json2data=jsonlab.loadubjson(ans)
...
data2json=zeros(0,3);
jsonlab.saveubjson('empty_0by3_real',data2json)
json2data=jsonlab.loadubjson(ans)
...
jsonlab.saveubjson('sparse_column_vector',data2json)
json2data=jsonlab.loadubjson(ans)
...
jsonlab.saveubjson('complex_sparse_column_vector',data2json)
json2data=jsonlab.loadubjson(ans)
...
data2json=sparse([0,3,0,1,4]);
jsonlab.saveubjson('sparse_row_vector',data2json)
json2data=jsonlab.loadubjson(ans)
...
data2json=data2json-1i*data2json;
jsonlab.saveubjson('complex_sparse_row_vector',data2json)
json2data=jsonlab.loadubjson(ans)
...
jsonlab.saveubjson('astruct',data2json,struct('ParseLogical',1))
json2data=jsonlab.loadubjson(ans)
...
jsonlab.saveubjson('Supreme Commander',data2json)
json2data=jsonlab.loadubjson(ans)
...
jsonlab.saveubjson('debian',data2json,struct('FloatFormat','%.2f'))
json2data=jsonlab.loadubjson(ans)
...
json2data=jsonlab.loadubjson(jsonlab.saveubjson('',jsonlab.loadjson('{"ValidName":1, "_InvalidName":2, ":Field:":3, "项目":"绝密"}')))
...
jsonlab.saveubjson('data2json',data2json)
json2data=jsonlab.loadubjson(ans)  % only savejson works for cell arrays, loadjson has issues
